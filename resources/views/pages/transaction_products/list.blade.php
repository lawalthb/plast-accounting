...
<?php
    ...
    $can_add = $user->canAccess("transaction_products/add");
    $can_edit = $user->canAccess("transaction_products/edit");
    $can_view = $user->canAccess("transaction_products/view");
    $can_delete = $user->canAccess("transaction_products/delete");
    $field_name = request()->segment(3);
    $field_value = request()->segment(4);
    $total_records = $records->total();
    $limit = $records->perPage();
    $record_count = count($records);
    $pageTitle = __('transactionProducts'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col col-md-auto  " >
                    <div class=" h5 font-weight-bold text-primary" >
                        {{ __('transactionProducts') }}
                    </div>
                </div>
                <div class="col-md-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary" href="<?php print_link("transaction_products/add", true) ?>" >
        ...
        <div class="row ">
            <div class="col-md-12 comp-grid " >
                ...
                <div  class=" page-content" >
                    <div id="transaction_products-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/transaction_products/", $field_name, $field_value); ?>
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-quantity <?php echo (get_value('orderby') == 'quantity' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('quantity', __('quantity'), ''); ?>
                                        </th>
                                        <th class="td-rate <?php echo (get_value('orderby') == 'rate' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('rate', __('rate'), ''); ?>
                                        </th>
                                        ...
                                        <th class="td-location_id <?php echo (get_value('orderby') == 'location_id' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('location_id', __('locationId'), ''); ?>
                                        </th>
                                        ...
                                        <th class="td-tp_date <?php echo (get_value('orderby') == 'tp_date' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('tp_date', __('tpDate'), ''); ?>
                                        </th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentStart-->
                                        <td class="td-id">
                                            <a href="<?php print_link("transaction_products/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                        </td>
                                        ...
                                        <td class="td-btn">
                                            <div class="dropdown" >
                                                ...
                                                <ul class="dropdown-menu">
                                                    <?php if($can_view){ ?>
                                                    <a class="dropdown-item "   href="<?php print_link("transaction_products/view/$rec_id"); ?>" >
                                                    <i class="material-icons">visibility</i> {{ __('view') }}
                                                </a>
                                                <?php } ?>
                                                <?php if($can_edit){ ?>
                                                <a class="dropdown-item "   href="<?php print_link("transaction_products/edit/$rec_id"); ?>" >
                                                <i class="material-icons">edit</i> {{ __('edit') }}
                                            </a>
                                            <?php } ?>
                                            <?php if($can_delete){ ?>
                                            <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("transaction_products/delete/$rec_id"); ?>" >
                ...
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto justify-content-center">    
                        <div class="d-flex justify-content-start">  
                            <?php if($can_delete){ ?>
                            <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("transaction_products/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
            ...
            <?php Html :: import_form('transaction_products/importdata' , __('importData'), 'CSV , JSON'); ?>
        </div>
    </div>
    <div class="col">   
        <?php
