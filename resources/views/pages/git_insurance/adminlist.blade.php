...
<?php
    ...
    $git_insurance_driver_name_option_list = $comp_model->git_insurance_driver_name_option_list();
    $git_insurance_going_to_option_list = $comp_model->git_insurance_going_to_option_list();
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto  " >
                    ...
                    <a href="<?php print_link("git_insurance/add", true) ?>"  class="btn btn-primary open-page-modal" >
...
<div  class="" >
    <div class="container-fluid">
            ...
            <div class="col-md-2 comp-grid " >
                <div class="q-mb-sm q-pa-sm sticky-top" >
                    ...
                    <ul class="nav nav-pills flex-column">
                        <?php 
                            $options = $git_insurance_driver_name_option_list ?? [];
                            foreach($options as $option){
                            $value = $option->value;
                            $label = $option->label ?? $value;
                            $nav_link = add_query_params(['git_insurance_driver_name' => $value] , false);
                        ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_link('git_insurance_driver_name', $value); ?>" href="<?php print_link($nav_link) ?>">
                            <?php echo $label; ?>
                        </a>
                    </li>
                    <?php
        ...
        <div class="q-mb-sm q-pa-sm sticky-top" >
            ...
            <ul class="nav nav-pills flex-column">
                <?php 
                    $options = $git_insurance_going_to_option_list ?? [];
                    foreach($options as $option){
                    $value = $option->value;
                    $label = $option->label ?? $value;
                    $nav_link = add_query_params(['git_insurance_going_to' => $value] , false);
                ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo is_active_link('git_insurance_going_to', $value); ?>" href="<?php print_link($nav_link) ?>">
                    <?php echo $label; ?>
                </a>
            </li>
            <?php
...
<div class="col-md-10 comp-grid " >
    ...
    <div class="filter-tags mb-2">
        <?php
            Html::filter_tag('git_insurance_driver_name', 'Driver Name', $git_insurance_driver_name_option_list);
        ?>
        <?php
            Html::filter_tag('git_insurance_going_to', 'Going To', $git_insurance_going_to_option_list);
        ?>
    </div>
