...
<?php
    ...
    $permissions_role_id_option_list_2 = $comp_model->permissions_role_id_option_list_2();
...
<div  class="" >
                ...
                <form method="get" action="" class="form">
                    <div class="q-mb-sm q-pa-sm sticky-top" >
                        ...
                        <ul class="nav nav-pills flex-column nav-justified">
                            <?php 
                                $options = $permissions_role_id_option_list_2 ?? [];
    ...
    <div class="col-10 comp-grid " >
        ...
        <div class="filter-tags mb-2">
            <?php
                Html::filter_tag('permissions_role_id', 'Role Name', $permissions_role_id_option_list_2);
            ?>
            <?php
        ...
        <div  class=" page-content" >
            <div id="permissions-adminlist-records">
                <div id="page-main-content" class="table-responsive">
                    <?php Html::page_bread_crumb("/permissions/adminlist", $field_name, $field_value); ?>
...
<?php Html :: import_form('permissions/importdata' , __('importData'), 'CSV , JSON'); ?>
</div>
</div>
<div class="col">   
    <?php
