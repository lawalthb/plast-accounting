                        ...
                        <form id="permissions-add-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="{{ route('permissions.store') }}" method="post" >
                            ...
                            <div>
                                <table class="table table-striped table-sm" data-maxrow="50" data-minrow="1">
                                    <thead>
                                        <tr>
                                            <th class="bg-light"><label for="role_id">{{ __('roleId') }}</label></th>
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        $checked = Html::get_field_checked('role_id', $value, "2");
                                    ?>
                                    <label class="form-check form-check-inline">
                                    <input class="form-check-input" <?php echo $checked; ?> value="<?php echo $value; ?>" type="radio"  name="row[<?php echo $row ?>][role_id]"   />
                            ...
                            <td>
                                ...
                                <input id="ctrl-permission-row<?php echo $row; ?>" data-field="permission"  value="<?php echo get_value('permission') ?>" type="text" placeholder="{{ __('enterPermission') }}" list="permission_list"  required="" name="row[<?php echo $row ?>][permission]"  class="form-control " />
