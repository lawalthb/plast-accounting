...
<div  class="" >
                ...
                <div class="q-mb-sm q-pa-sm sticky-top" >
                    ...
                    <ul class="nav nav-pills flex-column">
                        <?php 
                            ...
                            $nav_link = add_query_params(['locations_company_id' => $value] , false);
                        ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_link('locations_company_id', $value); ?>" href="<?php print_link($nav_link) ?>">
                            <?php echo $label; ?>
                        </a>
                    </li>
                    <?php
    ...
    <div class="col-md-10 comp-grid " >
        ...
        <div class="filter-tags mb-2">
            <?php
                Html::filter_tag('locations_company_id', 'Company', $document_types_company_id_option_list);
            ?>
        </div>
