...
<div class="bg-light p-2 subform">
    ...
    <div>
        ...
        <td>
            ...
            <input id="ctrl-ledger_id-row<?php echo $row; ?>" data-field="ledger_id"  value="<?php echo get_value('ledger_id') ?>" type="number" placeholder="{{ __('enterLedgerId') }}" step="any"  required="" name="transaction_ledgers[<?php echo $row ?>][ledger_id]"  class="form-control " />
        </div>
    </td>
    <td>
        <div id="ctrl-debit_id-row<?php echo $row; ?>-holder" class=" ">
        <input id="ctrl-debit_id-row<?php echo $row; ?>" data-field="debit_id"  value="<?php echo get_value('debit_id', "0.00") ?>" type="number" placeholder="{{ __('enterDebitId') }}" step="0.1"  required="" name="transaction_ledgers[<?php echo $row ?>][debit_id]"  class="form-control " />
    </div>
</td>
<td>
    <div id="ctrl-credit_id-row<?php echo $row; ?>-holder" class=" ">
    <input id="ctrl-credit_id-row<?php echo $row; ?>" data-field="credit_id"  value="<?php echo get_value('credit_id', "0.00") ?>" type="number" placeholder="{{ __('enterCreditId') }}" step="0.1"  required="" name="transaction_ledgers[<?php echo $row ?>][credit_id]"  class="form-control " />
</div>
</td>
<td>
    <div id="ctrl-comment-row<?php echo $row; ?>-holder" class=" ">
    <input id="ctrl-comment-row<?php echo $row; ?>" data-field="comment"  value="<?php echo get_value('comment', "NULL") ?>" type="number" placeholder="{{ __('enterComment') }}" step="any"  name="transaction_ledgers[<?php echo $row ?>][comment]"  class="form-control " />
</div>
</td>
<td>
    <div id="ctrl-company_id-row<?php echo $row; ?>-holder" class=" ">
    <select required=""  id="ctrl-company_id-row<?php echo $row; ?>" data-field="company_id" name="transaction_ledgers[<?php echo $row ?>][company_id]"  placeholder="{{ __('selectAValue') }}"    class="form-select" >
    <option value="">{{ __('selectAValue') }}</option>
    <?php 
