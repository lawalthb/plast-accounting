...
<?php
    $pageTitle = __('addNewDebitNote'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row ">
                ...
                <div  class="card-1 border rounded page-content" >
                    <!--[form-start]-->
                    <form id="transactions-add5007-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('transactions.add5007_store') }}" method="post">
                        @csrf
                        <div>
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    <label class="control-label" for="trans_no">{{ __('debitNoteNo') }} </label>
                                    <div id="ctrl-trans_no-holder" class=" "> 
                                        ...
                                        $doc_id = $_GET['document_type'] ; echo getNextDebitNo($doc_id);}else{
                                            echo "";
                                        }
                                         ?>" type="text" placeholder="{{ __('enterDebitNoteNo') }}"  name="trans_no"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group col-sm-3">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div id="ctrl-party_ledger_id-holder" class=" "> 
                                        ...
                                        <?php 
                                            $options = $comp_model->transactions_party_ledger_id_option_list() ?? [];
                                ...
                                <input id="ctrl-against_ledger_id" data-field="against_ledger_id"  value="<?php echo  getCompanyDebitId(); ?>" type="hidden" placeholder="{{ __('selectALedger') }}" list="against_ledger_id_list"  name="against_ledger_id"  class="form-control " />
                                ...
                                <input id="ctrl-document_type_code" data-field="document_type_code"  value="<?php echo get_value('document_type_code', "5007") ?>" type="hidden" placeholder="{{ __('enterDocumentTypeCode') }}"  required="" name="document_type_code"  class="form-control " />
                                <div class="form-group col-sm-6">
                                    <label class="control-label" for="total_debit">Debit Amount<span class="text-danger">*</span></label>
                                    <div id="ctrl-total_debit-holder" class=" "> 
                                        <input id="ctrl-total_debit2" data-field="total_debit"  value="<?php echo get_value('total_debit', "0.00") ?>" type="text" placeholder="{{ __('enterTotalAmount') }}"  required="" name="total_debit"  class="form-control " />
                                    <span id="sum" class="d-none">sum will be here</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).on("change", ".credit_value", function(){
  ...
  $("#sum").text(sum);
   var debit_value2 = $("#ctrl-total_debit2").val();
  //alert(debit_value2);
  if(sum == debit_value2 ){
