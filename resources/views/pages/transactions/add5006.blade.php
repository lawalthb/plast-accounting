...
<?php
    $pageTitle = __('addNewCreditNote'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row ">
                ...
                <div  class="card-1 border rounded page-content" >
                    <!--[form-start]-->
                    <form id="transactions-add5006-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('transactions.add5006_store') }}" method="post">
                        @csrf
                        <div>
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    <label class="control-label" for="trans_no">Credit Note No.:</label>
                                    <div id="ctrl-trans_no-holder" class=" "> 
                                        ...
                                        $doc_id = $_GET['document_type'] ; echo getNextCreditNo($doc_id);}else{
                                            echo "";
                                        }
                                ...
                                <input id="ctrl-against_ledger_id" data-field="against_ledger_id"  value="<?php echo  getCompanyCreditId(); ?>" type="hidden" placeholder="{{ __('selectALedger') }}" list="against_ledger_id_list"  name="against_ledger_id"  class="form-control " />
                                ...
                                <input id="ctrl-document_type_code" data-field="document_type_code"  value="<?php echo get_value('document_type_code', "5006") ?>" type="hidden" placeholder="{{ __('enterDocumentTypeCode') }}"  required="" name="document_type_code"  class="form-control " />
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div id="ctrl-total_credit-holder" class=" "> 
                                        <input id="ctrl-total_credit" data-field="total_credit"  value="<?php echo get_value('total_credit', "0.00") ?>" type="text" placeholder="{{ __('enterTotalCredit') }}"  required="" name="total_credit"  class="form-control " />
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).on("change", ".debit_value", function(){
    var sum = 0;
    $(".debit_value").each(function(){
        sum += +$(this).val();
    });
   $("#ctrl-total_debit").val(sum);
   var credit_value = $("#ctrl-total_credit").val();
  //alert(credit_value);
  if(sum == credit_value ){
