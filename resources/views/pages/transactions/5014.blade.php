                    ...
                    <form id="transactions-addreceipt-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('transactions.addreceipt_store') }}" method="post">
                        ...
                        <div class="bg-light p-2 subform">
                            ...
                            <td>
                                ...
                                <input id="ctrl-credit_id-row<?php echo $row; ?>" data-field="credit_id"  value="<?php echo get_value('credit_id') ?>" type="text" placeholder="{{ __('enterCreditAmount') }}"  required="" name="transaction_ledgers[<?php echo $row ?>][credit_id]"  class="form-control " />
                            </div>
                        </td>
                        <td>
