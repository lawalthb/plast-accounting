            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="users-adminadd-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('users.adminadd_store') }}" method="post">
                            @csrf
                            <div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div id="ctrl-user_role_id-holder" class=" "> 
                                            ...
                                            <?php 
                                                $options = $comp_model->users_user_role_id_option_list() ?? [];
