            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("companies/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div id="ctrl-slogan-holder" class=" "> 
                                        <input id="ctrl-slogan" data-field="slogan"  value="<?php  echo $data['slogan']; ?>" type="text" placeholder="{{ __('enterSloganDescription') }}"  name="slogan"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div id="ctrl-com_email-holder" class=" "> 
                                        <input id="ctrl-com_email" data-field="com_email"  value="<?php  echo $data['com_email']; ?>" type="email" placeholder="{{ __('enterCompanyEmail') }}"  name="com_email"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div id="ctrl-com_phone-holder" class=" "> 
                                        <input id="ctrl-com_phone" data-field="com_phone"  value="<?php  echo $data['com_phone']; ?>" type="text" placeholder="{{ __('enterCompanyPhone') }}"  name="com_phone"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
