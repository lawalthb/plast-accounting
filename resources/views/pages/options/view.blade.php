...
<?php
    ...
    $pageTitle = __('optionsDetails'); //set dynamic page title
?>
@extends($layout)
                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            <div class="page-data">
                                ...
                                <div class="mb-3 row row gutter-lg">
                                    ...
                                    <div class=" col-12 col-md-4">
                                        <div class="bg-light mb-3 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">{{ __('optionName') }}</small>
                                                    <div class="fw-bold">
                                    ...
                                    <div class=" col-12 col-md-4">
                                        <div class="bg-light mb-3 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">{{ __('optionValue') }}</small>
                                                    <div class="fw-bold">
                                ...
                                <div class=" col-12 col-md-4">
                                    <div class="bg-light mb-3 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">{{ __('updatedBy') }}</small>
                                                <div class="fw-bold">
                            ...
                            <div class="d-flex gap-1 justify-content-start">
                                <?php if($can_edit){ ?>
                                <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("options/edit/$rec_id"); ?>" >
                                <i class="material-icons">edit</i> {{ __('edit') }}
                            </a>
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("options/delete/$rec_id?redirect=options"); ?>" >
