            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="document_types-adminadd-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('document_types.adminadd_store') }}" method="post">
                            @csrf
                            <div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div id="ctrl-document_code-holder" class=" "> 
                                            ...
                                            <?php 
                                                $options = $comp_model->document_types_document_code_option_list() ?? [];
                                                foreach($options as $option){
                                                $value = $option->value;
                                ...
                                <div class="form-group ">
                                    <label class="control-label" for="no_view">{{ __('noView') }} <span class="text-danger">*</span></label>
                                    <div id="ctrl-no_view-holder" class=" "> 
                                        <input id="ctrl-no_view" data-field="no_view"  value="<?php echo get_value('no_view', "0") ?>" type="number" placeholder="{{ __('enterNoView') }}" step="any"  required="" name="no_view"  class="form-control " />
                                    </div>
                                </div>
                            </div>
