                ...
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        ...
                        <div>
                            ...
                            <input id="ctrl-created_by" data-field="created_by"  value="<?php  echo $data['created_by']; ?>" type="hidden" placeholder="{{ __('enterCreatedBy') }}"  required="" name="created_by"  class="form-control " />
                        </div>
