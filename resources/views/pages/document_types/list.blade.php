        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary" href="<?php print_link("document_types/add", true) ?>" >
...
<div  class="" >
                ...
                <div class="q-mb-sm q-pa-sm sticky-top" >
                    ...
                    <ul class="nav nav-pills flex-column">
                        <?php 
                            ...
                            $nav_link = add_query_params(['document_types_company_id' => $value] , false);
                        ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_link('document_types_company_id', $value); ?>" href="<?php print_link($nav_link) ?>">
                            <?php echo $label; ?>
                        </a>
                    </li>
                    <?php
    ...
    <div class="col-10 comp-grid " >
        ...
        <div class="filter-tags mb-2">
            <?php
                Html::filter_tag('document_types_company_id', 'Company Id', $document_types_company_id_option_list);
            ?>
        </div>
        <div  class=" page-content" >
            <div id="document_types-list-records">
                <div class="row gutter-lg ">
                    <div class="col">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/document_types/", $field_name, $field_value); ?>
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-starting_num <?php echo (get_value('orderby') == 'starting_num' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('starting_num', __('startingNum'), ''); ?>
                                        </th>
                                        <th class="td-common_description <?php echo (get_value('orderby') == 'common_description' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('common_description', __('commonDescription'), ''); ?>
                                        </th>
                                        <th class="td-print_onsave <?php echo (get_value('orderby') == 'print_onsave' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('print_onsave', __('printOnsave'), ''); ?>
                                        </th>
                                        <th class="td-desc_each_line <?php echo (get_value('orderby') == 'desc_each_line' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('desc_each_line', __('descEachLine'), ''); ?>
                                        </th>
                                        <th class="td-document_code <?php echo (get_value('orderby') == 'document_code' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('document_code', __('documentCode'), ''); ?>
                                        </th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <td class="td-id">
                                        <a href="<?php print_link("document_types/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                    </td>
                                    <td class="td-name">
                                        <?php echo  $data['name'] ; ?>
                                    </td>
                                    ...
                                    <td class="td-btn">
                                        <div class="dropdown" >
                                            ...
                                            <ul class="dropdown-menu">
                                                <?php if($can_view){ ?>
                                                <a class="dropdown-item "   href="<?php print_link("document_types/view/$rec_id"); ?>" >
                                                <i class="material-icons">visibility</i> {{ __('view') }}
                                            </a>
                                            <?php } ?>
                                            <?php if($can_edit){ ?>
                                            <a class="dropdown-item "   href="<?php print_link("document_types/edit/$rec_id"); ?>" >
                                            <i class="material-icons">edit</i> {{ __('edit') }}
                                        </a>
                                        <?php } ?>
                                        <?php if($can_delete){ ?>
                                        <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("document_types/delete/$rec_id"); ?>" >
    ...
    <div class="col-12">
        <div class=" ">
            <div id="document_types-detail-page" class="master-detail-page"></div>
        </div>
    </div>
    <?php } ?>
</div>
