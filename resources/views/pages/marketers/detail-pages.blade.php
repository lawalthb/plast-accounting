    ...
    <div class="master-detail-page card">
        <div class="card-header text-bold h5 p-3 mb-3">Marketers Records</div>
        <div class="p-2">
    ...
    <div class="tab-content">
        ...
        <div class=" ">
            <?php
                $params = ['marketer_id' => $rec_id,'show_header' => false]; //new query param
                $query = array_merge(request()->query(), $params);
                $queryParams = http_build_query($query);
                $url = url("ledgers/index/marketer_id/$rec_id?$queryParams");
            ?>
