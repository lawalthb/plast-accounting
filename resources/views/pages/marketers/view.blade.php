...
<?php
    ...
    $pageTitle = __('marketersDetails'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 comp-grid " >
                            ...
                            <div class="row gutter-lg ">
                                <div class="col">
                                    ...
                                    <div class="d-flex gap-1 justify-content-start">
                                        <?php if($can_edit){ ?>
                                        <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("marketers/edit/$rec_id"); ?>" >
                                        <i class="material-icons">edit</i> {{ __('edit') }}
                                    </a>
                                    <?php } ?>
                                    <?php if($can_delete){ ?>
                                    <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("marketers/delete/$rec_id?redirect=marketers"); ?>" >
                    ...
                    <div class="col-12">
                        <div class="my-3 p-1 ">
                            @include("pages.marketers.detail-pages", ["masterRecordId" => $rec_id])
                        </div>
                    </div>
                    <?php } ?>
                </div>
