            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("products/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div id="ctrl-qty-holder" class=" "> 
                                        <input id="ctrl-qty" data-field="qty"  value="<?php  echo $data['qty']; ?>" type="number" placeholder="{{ __('enterOpeningQuantity') }}" step="0.1"  required="" name="qty"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label" for="dead_stock">{{ __('deadStock') }} </label>
                                    <div id="ctrl-dead_stock-holder" class="input-group "> 
                                        <?php
                                        ...
                                        <input class="form-check-input" <?php echo $checked ?>  value="<?php echo $value ?>" type="radio"   name="dead_stock" />
