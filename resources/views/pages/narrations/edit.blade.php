...
<?php
    $pageTitle = __('editNarrations'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("narrations/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            <div class="form-group ">
                                ...
                                <div id="ctrl-narration-holder" class=" "> 
                                    <textarea placeholder="{{ __('enterNarration') }}" id="ctrl-narration" data-field="narration"  rows="2" name="narration" class=" form-control"><?php  echo $data['narration']; ?></textarea>
