...
<div  class="" >
                ...
                <div class="q-mb-sm q-pa-sm sticky-top" >
                    ...
                    <ul class="nav nav-pills flex-column">
                        <?php
                            ...
                            $value = $option['value'];
                            $label = $option['label'];
                            $nav_link = add_query_params(array('product_categories_is_active' => $value ) , false);
                            $is_active = is_active_link('product_categories_is_active', $value);
                        ?>
                        <li class="nav-item">
    ...
    <div class="col-10 comp-grid " >
        ...
        <div class="filter-tags mb-2">
            <?php
                Html::filter_tag('product_categories_is_active', 'Is Active', Menu::common_description());
            ?>
        </div>
