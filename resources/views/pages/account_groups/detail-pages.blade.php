    ...
    <div class="master-detail-page card">
        ...
        <div class="p-2">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a data-bs-toggle="tab" href="#sub_account_group_<?php echo $page_id ?>" class="nav-link active">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="sub_account_group_<?php echo $page_id ?>" role="tabpanel">
        <div class=" ">
            <?php
