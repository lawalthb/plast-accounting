            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="transaction_ledgers-add4receipt-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="{{ route('transaction_ledgers.add4receipt_store') }}" method="post" >
                            @csrf
                            <div>
