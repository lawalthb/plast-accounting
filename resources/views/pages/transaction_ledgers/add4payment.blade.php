            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="transaction_ledgers-add4payment-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="{{ route('transaction_ledgers.add4payment_store') }}" method="post" >
                            @csrf
                            <div>
                            ...
                            <td>
                                ...
                                <input id="ctrl-debit_id-row<?php echo $row; ?>" data-field="debit_id"  value="<?php echo get_value('debit_id', "0.00") ?>" type="number" placeholder="{{ __('enterDebitAmount') }}" step="0.1"  required="" name="row[<?php echo $row ?>][debit_id]"  class="form-control " />
                            </div>
                        </td>
                        <td>
