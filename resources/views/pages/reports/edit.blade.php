                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div id="ctrl-report_code-holder" class=" "> 
                                        <input id="ctrl-report_code" data-field="report_code"  value="<?php  echo $data['report_code']; ?>" type="number" placeholder="{{ __('enterReportCode') }}" step="any"  name="report_code"  class="form-control " />
                                    </div>
                                </div>
                            </div>
                        </div>
