...
<link rel="stylesheet" href="{{ asset('css/selectize.css') }}" />
	...
	$('#sidebar').css('height', 'calc(100vh - ' +  navTopHeight + 'px)');
	// var state = sessionStorage.getItem("sidebar");
	// if (state) {
	// 	$('#sidebar, #main-content').addClass('sidebar-hide');
	// } else {      	
	// 	$('#sidebar, #main-content').removeClass('sidebar-hide');
	// }
	$('#sidebarCollapse').on('click', function () {
		$('#sidebar, #main-content').toggleClass('sidebar-hide');
